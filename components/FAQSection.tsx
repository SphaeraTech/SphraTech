...
const faqCategories = [
    { icon: HelpCircle, color: 'from-red-500 to-rose-500' },
    { icon: FileQuestion, color: 'from-rose-600 to-red-600' },
    { icon: MessageCircle, color: 'from-red-600 to-orange-500' },
    { icon: Lightbulb, color: 'from-rose-500 to-red-500' }
];
...
export default function FAQSection() {
    ...
    return (
        <section id="faq" className="py-20 px-6  pb-100  ">
